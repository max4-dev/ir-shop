...
import { ProductDetailActions, ProductImageGallery } from "@/src/widgets/product/ui";

import styles from "./ProductDetailPage.module.css";

export const ProductDetailPage = async ({ product }: { product: Product }) => {
  return (
    <Container>
      <div className={styles.page}>
        ...
        <article className={styles.layout}>
          ...
          <div className={styles.info}>
            ...
            <Separator indents="md" />
            <ProductDetailActions productId={product.id} isAvailable={product.isAvailable} />
          </div>
        </article>
      </div>
    </Container>
